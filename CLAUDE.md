...
shared/
  ...
  css/
    ...
    components.css       # Barrel pur (v2.36.0) — 30 @import vers components/ dans l'ordre cascade
    components-core.css  # Barrel essentiel (v2.36.0) — 9 modules essentiels (~14,5 KB gzip) pour consumers légers
    components/          # 30 modules CSS (v2.73.0) : _base, signature (v2.42.0), brand (v2.56.0 — wordmark + mark DS), cards, buttons, badges, theming, forms, data,
